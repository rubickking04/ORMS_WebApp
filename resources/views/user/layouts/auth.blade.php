        ...
        <nav class="navbar navbar-expand-lg shadow-sm" >
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <ul class="navbar-nav mx-auto">
                    <li class="nav-item">
                        <a class="nav-link list-link active" aria-current="page" href="{{ route('user.home') }}">{{ __('Home') }}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link list-link active" href="#">{{ __('Order') }}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link list-link active" href="#">{{ __('Cart') }}</a>
                    </li>
                </ul>
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0 ">
                    <div class="hstack gap-3">
                        @guest
                        <li class="nav-item">
                            <a class="nav-link list-link active" href="{{ route('login') }}">{{ __('Login') }}</a>
                        </li>
                        {{-- <li class="nav-item">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-center" aria-labelledby="navbarDropdown">
                                <div class="container">
                                    <a class="dropdown-item" href="{{ route('user.home') }}"><i class="fas fa-user fs-6 "></i><span class="ms-2 ">{{ __('My Profile') }}</span></a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link list-link active" href="{{ route('register') }}">{{ __('Register') }}</a>
                        </li>
                    </div>
                </ul>
            </div>
